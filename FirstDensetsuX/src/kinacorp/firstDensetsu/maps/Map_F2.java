...
public class Map_F2 extends Map_Base
{

	public Map_F2(State_Gameplay gameplay) 
	{
	 super(gameplay);
	 ...
	 map = mapLoader.load("data/mapF2.tmx",parameters);
	...
	public void callEvent(Entity_Event ev)
	{
	 if(ev.ev == 1)
	 {
	  ...
	  {
	   gameplay.map_manager.changeMap(0,new Map_F1(gameplay));
	  }
	 }
	 ...
	 if(ev.ev == 2)
	 {
	  ...
	  {
	   gameplay.map_manager.changeMap(1,new Map_F3(gameplay));
	  }
	 }
	 ...
	 if(ev.ev == 3)
	 {
	  ...
	  {
	   gameplay.map_manager.changeMap(2,new Map_F4(gameplay));
	  }
	 }
	 ...
	 if(ev.ev == 4)
	 {
	  ...
	  {
	   gameplay.map_manager.changeMap(3,new Map_F5(gameplay));
	  }
	 }
	}
