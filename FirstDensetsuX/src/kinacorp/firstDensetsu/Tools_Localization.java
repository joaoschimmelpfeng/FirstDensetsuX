...
public class Tools_Localization {
        private static Tools_Localization _instance = null;
        
        private static final String LANGUAGES_FILE = "language/languages.xml";
        ...
        public static Tools_Localization getInstance() {
                if (_instance == null) {
                        _instance = new Tools_Localization();
                }
